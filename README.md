...
src/
  ...
  components/
    ...
    TitleCard.jsx  \
    TitleGrid.jsx    -->  + TitleGrid.module.css (shared)
    DetailOverlay.jsx  \
...
| `--accent` | TWICE neon magenta — buttons, active states, glow |
| `--accent-soft` | secondary pink, glyphs |
| `--gold` | reserved for future highlight use |
| `--text` / `--text-muted` | primary / secondary text |

Change these once and the whole app re-themes.
